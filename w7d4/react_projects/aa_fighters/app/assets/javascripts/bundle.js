...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	    ...
	    Roster = __webpack_require__(159);
	
	window.FighterStore = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var FighterForm = __webpack_require__(161);
	var FighterData = __webpack_require__(162);
	...
	var Roster = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement('input', { value: this.state.inputVal,
	      ...
	      React.createElement(
	        ...
	        this.matches().map((function (fighter, idx) {
	          ...
	          return React.createElement(
	            'li',
	            { key: idx, className: boldClass },
	            fighter.name
	          );
	        }).bind(this))
	      ),
	      React.createElement('hr', null),
	      React.createElement(FighterData, { name: this.state.inputVal }),
	      React.createElement('hr', null),
	      React.createElement(FighterForm, null)
	    );
	  }
	});
	...
	var FighterForm = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(
	        "form",
	        { onSubmit: this.handleNewFighter },
	        "Name: ",
	        ...
	        React.createElement("br", null),
	        React.createElement("input", { type: "submit", value: "New Fighter" })
	      )
	    );
	  }
	});
	...
	var FighterData = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { style: { width: 100, height: 100, backgroundColor: fighter.power } },
	        'Power'
	      ),
	      React.createElement(
	        'div',
